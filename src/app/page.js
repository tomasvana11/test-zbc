...
export default async function Page() {
  ...
  <div className="absolute bottom-12 left-4 md:left-12 z-10 overflow-visible">
    <img
      src="/images/symbol-outline.svg"
      alt=""
      className="w-[120vw] max-w-none md:w-[736px]" // přesahuje viewport
    />
  </div>
        ...
        <div className="w-full max-w-[1392px] mx-auto text-center">
          ...
          <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
              <div className="bg-cardBeige p-5 rounded-lg flex flex-col gap-5 items-center">
                ...
                <h4 className="card-heading-d text-raisinBlack mt-2 text-center">{hp_fp_card_1}</h4>
              </div>
              <div className="bg-cardBeige p-5 rounded-lg flex flex-col gap-5 items-center">
...
<footer className="bg-raisinBlack w-full px-4">
  <div className="flex flex-col md:flex-row w-full items-center max-w-[1392px] mx-auto justify-between py-12 md:py-16">
    <div className="flex flex-row">
      ...
      <p className="text-silkBeige pl-48">Za bohatší Česko s.r.o<br />Jankovcova 1569/2c 170 00, Praha 7<br />+420 603 818 647 <br />info@zabohatsicesko.cz</p>
    </div>
    <div>
  ...
  <div className="flex flex-col md:flex-row w-full items-center max-w-[1392px] mx-auto py-8 md:py-12">
    <p className="text-silkBeige text-center mx-auto">© 2025 Za bohatší Česko | Všechna práva vyhrazena | Ochrana osobních údajů | Cookies</p>
  </div>
</footer>

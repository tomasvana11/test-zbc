export default function PageHeader({ title, date, imageUrl }) {
  return (
    ...
    >
      ...
      {/* Text */}
      <div className="relative z-20 flex flex-column md:flex-row gap-[24px] md:gap-[48px] w-full max-w-[1392px] mx-auto py-8 md:py-12 items-center mt-[56px] md:mt-[64px] mb-[100px] md:mb-[144px]">

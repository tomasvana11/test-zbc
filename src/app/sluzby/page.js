    ...
    <div className="w-full flex flex-col lg:flex-row">
      ...
      <div className="w-full lg:w-2/3 grid grid-cols-1 gap-8 md:gap-10">
        ...
        <div className="flex flex-col md:flex-row gap-6">
            <div className="rounded-br-[12px] w-[64px] h-[64px] md:w-[80px] md:h-[80px] bg-silkBeige flex align-center text-center justify-center">
            <span className="recife text-[28px] md:text-[36px] text-raisinBlack">01</span>
            </div>

...
export default async function CareerPage() {
  ...
  const career_why_imgAlt =
    careerPage.acf?.career_why_img?.alt || "Intro obrázek";
            ...
            <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
              <div className="bg-cardBeige p-5 rounded-lg flex flex-col gap-5 items-center">
                ...
                <div
                  ...
                  dangerouslySetInnerHTML={{ __html: career_ben_card_1 }}
                />
              </div>
              <div className="bg-cardBeige p-5 rounded-lg flex flex-col gap-5 items-center">
                <img
                ...
                <div
                  className="mt-2 text-center card-text-fp text-goldenBrown"
                  dangerouslySetInnerHTML={{ __html: career_ben_card_2 }}
                />
              </div>
              <div className="bg-cardBeige p-5 rounded-lg flex flex-col gap-5 items-center">
                <img
                ...
                <div
                  className="mt-2 text-center card-text-fp text-goldenBrown"
                  dangerouslySetInnerHTML={{ __html: career_ben_card_3 }}
                />
              </div>
              <div className="bg-cardBeige p-5 rounded-lg flex flex-col gap-5 items-center">
                <img
                ...
                <div
                  className="mt-2 text-center card-text-fp text-goldenBrown"
                  dangerouslySetInnerHTML={{ __html: career_ben_card_4 }}
                />
              </div>
              <div className="bg-cardBeige p-5 rounded-lg flex flex-col gap-5 items-center">
                <img
                ...
                <div
                  className="mt-2 text-center card-text-fp text-goldenBrown"
                  dangerouslySetInnerHTML={{ __html: career_ben_card_5 }}
                />
              </div>
            </div>
          </div>
      ...
      {positions.map((position) => (
        ...
        <section className="px-4 w-full py-12 md:py-24 bg-silverSage recenze">
          <div className="w-full max-w-[1392px] mx-auto text-center">
                ...
                >
                  ...
                  <div className="flex flex-col gap-2 absolute bottom-10 left-10">
                    {item.acf?.client_name && (
                      <p className="text-goldenBrown text-left font-bold">
                        {item.acf.client_name}
                      </p>
                    )}
                    {item.acf?.client_since && (
                      <p className="text-raisinBlack text-left opacity-75">
                        Klient/ka od roku {item.acf.client_since}
                      </p>
                    )}
                  </div>
                </div>
            ...
            <a
              href="https://www.zabohatsicesko.cz/reference"
              className="custom-btn py-3 px-4 rounded bg-goldenBrown text-silkBeige mt-8 inline-block text-center"
            >
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <select name="typ" id="typ" required className="hidden">
                  <option value="spolupracovník " selected></option>
                </select>
                <input
                  type="text"
                  name="firstName"
...
export default async function CareerPage() {
  ...
  // ACF pole z Homepage (Vize a Mise)
  const hp_m_title = homepage.acf?.hp_m_title || "";
  const hp_m_desc = homepage.acf?.hp_m_desc || "";
  const hp_v_title = homepage.acf?.hp_v_title || "";
  const hp_v_desc = homepage.acf?.hp_v_desc || "";
  ...
  export default async function CareerPage() {
    ...
    // Nová pole pro sekci Nábor
    const career_nabor_title_teaser = careerPage.acf?.career_nabor_title_teaser || "";
    const career_nabor_title = careerPage.acf?.career_nabor_title || "";
    const recr_t1 = careerPage.acf?.recr_t1 || "";
    const recr_d1 = careerPage.acf?.recr_d1 || "";
    const recr_t2 = careerPage.acf?.recr_t2 || "";
    const recr_d2 = careerPage.acf?.recr_d2 || "";
    const recr_t3 = careerPage.acf?.recr_t3 || "";
    const recr_d3 = careerPage.acf?.recr_d3 || "";
    const recr_t4 = careerPage.acf?.recr_t4 || "";
    const recr_d4 = careerPage.acf?.recr_d4 || "";
    const recr_t5 = careerPage.acf?.recr_t5 || "";
    const recr_d5 = careerPage.acf?.recr_d5 || "";

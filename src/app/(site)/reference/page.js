          ...
          <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {recenze.map((item) => {
              ...
              return (
                <div
                  key={item.id}
                  className="relative pt-10 pl-10 ml-2 md:ml-6 mb-2 md:mb-0 rounded-lg flex flex-row gap-5 items-start overflow-visible bg-gradient-to-b from-[#E2DBD5] to-[#D6D6D3]"
                >
                  {/* Dekorační obrázek */}
                  <img

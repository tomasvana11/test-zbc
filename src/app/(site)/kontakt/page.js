    ...
    <main>
        ...
        <div className="flex flex-col md:flex-row w-full max-w-[1392px] mx-auto py-12 md:py-24">
            ...
            <div className="flex flex-col md:grid md:grid-cols-2">
                {/* Blok 1 */}
                <div className="p-[64px_77px] border-b border-lightDivGrey md:border-b md:border-r border-lightDivGrey">
            ...
            {/* Blok 2 */}
            <div className="p-[64px_77px] border-b border-lightDivGrey md:border-b border-lightDivGrey">
            <h2 className="mb-2">Nadpis 2</h2>
            <p>Text 2</p>
            </div>

            {/* Blok 3 */}
            <div className="p-[64px_77px] border-b border-lightDivGrey md:border-b-0 md:border-r border-lightDivGrey">
            <h2 className="mb-2">Nadpis 3</h2>
            <p>Text 3</p>
            </div>

            {/* Blok 4 */}
            <div className="p-[64px_77px] border-b border-lightDivGrey md:border-b-0 border-lightDivGrey">
